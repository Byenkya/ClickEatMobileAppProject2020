...
public class FragmentForgotPasswordBindingImpl extends FragmentForgotPasswordBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.forgotPasswordLayout, 1);
        sViewsWithIds.put(R.id.reset_email_layout, 2);
        sViewsWithIds.put(R.id.reset_email, 3);
        sViewsWithIds.put(R.id.submit__reset, 4);
    }
    // views
    @NonNull
