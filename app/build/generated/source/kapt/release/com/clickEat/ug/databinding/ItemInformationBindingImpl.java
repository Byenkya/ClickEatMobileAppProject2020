...
public class ItemInformationBindingImpl extends ItemInformationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.item_name_label, 1);
        sViewsWithIds.put(R.id.item_name, 2);
        sViewsWithIds.put(R.id.desc_label, 3);
        sViewsWithIds.put(R.id.desc, 4);
        sViewsWithIds.put(R.id.price_label, 5);
        sViewsWithIds.put(R.id.price, 6);
        sViewsWithIds.put(R.id.dismiss, 7);
    }
    // views
    @NonNull
