...
public final class MenuViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    private final void getAllProducts(int restaurant_id) {
    }
    ...
    public MenuViewModel(int restaurant_id, @org.jetbrains.annotations.NotNull()
